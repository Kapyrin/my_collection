...
### - It includes functionality similar to standard Java collections such as `ArrayList` and  `LinkedList` with methods for adding, removing, setting, sorting bubble sorting and others...
